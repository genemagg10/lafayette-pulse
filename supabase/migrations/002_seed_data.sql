...
(
  ...
  2500000.00,
  'agenda',
  ARRAY['bike_ped', 'bike lane', 'complete streets', 'downtown', 'pedestrian safety']
),
(
  ...
  850000.00,
  'agenda',
  ARRAY['parks_trails', 'trail', 'lighting', 'ADA', 'wayfinding']
),
(
  ...
  420000.00,
  'agenda',
  ARRAY['safe_routes', 'SRTS', 'crosswalk', 'school zone', 'walking bus', 'Burton Valley']
),
(
  ...
  180000.00,
  'agenda',
  ARRAY['traffic_calming', 'speed cushions', 'radar signs', 'traffic circle', 'cut-through traffic']
),
(
  ...
  3200000.00,
  'agenda',
  ARRAY['capital_projects', 'intersection', 'signal', 'safety', 'bike lanes']
),
(
  ...
  NULL,
  'agenda',
  ARRAY['city_council', 'transportation plan', 'Vision Zero', 'policy', 'bike network']
),
(
  ...
  250000.00,
  'agenda',
  ARRAY['safe_routes', 'SRTS', 'school zone', 'crosswalk', 'Springhill']
),
(
  ...
  680000.00,
  'agenda',
  ARRAY['bike_ped', 'bike lane', 'BART connection', 'corridor']
),
(
  ...
  1500000.00,
  'agenda',
  ARRAY['parks_trails', 'trail connector', 'Briones', 'multi-use', 'grade separation']
),
(
  ...
  95000.00,
  'agenda',
  ARRAY['traffic_calming', 'speed reduction', 'radar signs', 'pilot program', 'Moraga Road']
);
...
(
  ...
  NULL,
  ARRAY['city_council', 'transportation plan', 'Vision Zero', 'study session']
),
(
  '2026-02-20',
  ...
  NULL,
  ARRAY['traffic_calming', 'Happy Valley', 'design review']
),
(
  '2026-02-18',
  ...
  NULL,
  ARRAY['parks_trails', 'trail', 'lighting', 'construction update']
),
(
  '2026-02-10',
  'City Council',
  ...
  NULL,
  ARRAY['safe_routes', 'SRTS', 'grant', 'Burton Valley', 'consent calendar']
),
(
  '2026-02-06',
  'Circulation Commission',
  ...
  NULL,
  ARRAY['traffic_calming', 'speed reduction', 'pilot', 'Moraga Road', 'progress report']
),
(
  '2026-01-27',
  'City Council',
  ...
  NULL,
  ARRAY['capital_projects', 'CIP', 'budget', 'intersection', 'engineering']
);
